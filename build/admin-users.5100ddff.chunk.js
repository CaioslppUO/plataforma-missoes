  ...
  return /* @__PURE__ */ react.createElement(Table.Tbody, null, rows.map((data) => {
    ...
    return /* @__PURE__ */ react.createElement(Table.Tr, __spreadValues({
      ...
      return /* @__PURE__ */ react.createElement(Table.Td, {
        key
      }, typeof cellFormatter === "function" ? cellFormatter(data, __spreadValues({ key, name }, rest)) : /* @__PURE__ */ react.createElement(Typography.Typography, {
      ...
      label: formatMessage({ id: "app.component.table.edit", defaultMessage: "Edit {target}" }, { target: (0,utils/* getFullName */.Pp)(data.firstname, data.lastname) }),
      noBorder: true,
      ...
      label: formatMessage({ id: "global.delete-target", defaultMessage: "Delete {target}" }, { target: (0,utils/* getFullName */.Pp)(data.firstname, data.lastname) }),
      noBorder: true,
...
const fetchData = (search, notify) => __async(undefined, null, function* () {
  const {
    data: { data }
...
const deleteData = (ids) => __async(undefined, null, function* () {
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _admin_src_pages_SettingsPage_pages_Users_ListPage_ModalForm_utils_formDataModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(79313);
var __defProp = Object.defineProperty;
var __getOwnPropSymbols = Object.getOwnPropertySymbols;
var __hasOwnProp = Object.prototype.hasOwnProperty;
var __propIsEnum = Object.prototype.propertyIsEnumerable;
