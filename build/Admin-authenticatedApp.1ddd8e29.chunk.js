...
const package_namespaceObject = {"i8":"4.1.9"};
...
// EXTERNAL MODULE: ./node_modules/@strapi/admin/node_modules/@strapi/design-system/MainNav.js
var MainNav = __webpack_require__(54035);
...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  const { menuLogo } = (0,useConfigurations/* default */.Z)();
...
`;
const Button = styled_components_browser_cjs["default"].button`
...
var layout = __webpack_require__(76910);
...
var design_system_Button = __webpack_require__(64459);
...
const Modal = ({ onClose, onSkip, children, hideSkip }) => {
  ...
  return /* @__PURE__ */ react.createElement(Portal.Portal, null, /* @__PURE__ */ react.createElement(ModalWrapper, {
    ...
    justifyContent: "flex-end"
  }, /* @__PURE__ */ react.createElement(design_system_Button.Button, {
    variant: "tertiary",
    onClick: onSkip
  }, formatMessage({
...
var StepLine = __webpack_require__(66952);
// EXTERNAL MODULE: ./.cache/admin/src/components/GuidedTour/Stepper/StepNumber.js
var StepNumber = __webpack_require__(71289);
...
var constants = __webpack_require__(16289);
...
const StepperModal = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Flex.Flex, {
    ...
    last: true
  }))), /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(components_Content, __spreadValues({}, content)), cta && (cta.target ? /* @__PURE__ */ react.createElement(LinkButton.LinkButton, {
    endIcon: /* @__PURE__ */ react.createElement((ArrowRight_default()), null),
    onClick: onCtaClick,
    to: cta.target
  }, formatMessage(cta.title)) : /* @__PURE__ */ react.createElement(design_system_Button.Button, {
    endIcon: /* @__PURE__ */ react.createElement((ArrowRight_default()), null),
    onClick: onCtaClick
...
const CM = (0,react.lazy)(() => Promise.all(/* import() | content-manager */[__webpack_require__.e(3852), __webpack_require__.e(9491), __webpack_require__.e(7169), __webpack_require__.e(6561), __webpack_require__.e(3714), __webpack_require__.e(994)]).then(__webpack_require__.bind(__webpack_require__, 50706)));
const HomePage = (0,react.lazy)(() => Promise.all(/* import() | Admin_homePage */[__webpack_require__.e(6798), __webpack_require__.e(3981)]).then(__webpack_require__.bind(__webpack_require__, 87512)));
const InstalledPluginsPage = (0,react.lazy)(() => __webpack_require__.e(/* import() | Admin_pluginsPage */ 3677).then(__webpack_require__.bind(__webpack_require__, 7235)));
const MarketplacePage = (0,react.lazy)(() => Promise.all(/* import() | Admin_marketplace */[__webpack_require__.e(3852), __webpack_require__.e(5516)]).then(__webpack_require__.bind(__webpack_require__, 65560)));
const NotFoundPage = (0,react.lazy)(() => Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 92776)));
const InternalErrorPage = (0,react.lazy)(() => __webpack_require__.e(/* import() */ 3224).then(__webpack_require__.bind(__webpack_require__, 40953)));
const ProfilePage = (0,react.lazy)(() => __webpack_require__.e(/* import() | Admin_profilePage */ 9497).then(__webpack_require__.bind(__webpack_require__, 60762)));
const SettingsPage = (0,react.lazy)(() => Promise.all(/* import() | Admin_settingsPage */[__webpack_require__.e(3852), __webpack_require__.e(9491), __webpack_require__.e(7169), __webpack_require__.e(3667), __webpack_require__.e(5895)]).then(__webpack_require__.bind(__webpack_require__, 34759)));
const useTrackUsage = () => {
  const { trackUsage } = (0,build.useTracking)();
  (0,react.useEffect)(() => {
...
var RBACProvider_constants = __webpack_require__(68493);
...
const RBACProvider = ({ children, permissions, refetchPermissions }) => {
  const { allPermissions } = (0,react_redux_lib/* useSelector */.v9)((state) => state.rbacProvider);
  const dispatch = (0,react_redux_lib/* useDispatch */.I0)();
  (0,react.useEffect)(() => {
...
const fetchStrapiLatestRelease = (toggleNotification) => __async(undefined, null, function* () {
  try {
    const {
      data: { tag_name }
...
const fetchAppInfo = () => __async(undefined, null, function* () {
  try {
...
const fetchCurrentUserPermissions = () => __async(undefined, null, function* () {
  try {
...
const fetchUserRoles = () => __async(undefined, null, function* () {
  try {
    const {
      data: {
        data: { roles }
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16289);
var __defProp = Object.defineProperty;
var __getOwnPropSymbols = Object.getOwnPropertySymbols;
var __hasOwnProp = Object.prototype.hasOwnProperty;
var __propIsEnum = Object.prototype.propertyIsEnumerable;
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16289);
