...
var getTrad = __webpack_require__(26434);
...
var permissions = __webpack_require__(48763);
...
const fetchEmailSettings = () => api_async(undefined, null, function* () {
  const { data } = yield axiosInstance.get("/email/settings");
  return data.config;
});
const postEmailTest = (body) => api_async(undefined, null, function* () {
...
const SettingsPage = () => {
  ...
  const handleSubmit = (event) => Settings_async(undefined, null, function* () {
