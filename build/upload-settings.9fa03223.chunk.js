...
var permissions = __webpack_require__(24442);
...
const SettingsPage = () => {
  ...
  const [{ initialData, isLoading, isSubmiting, modifiedData }, dispatch] = (0,react.useReducer)(SettingsPage_reducer, initialState, SettingsPage_init);
  ...
  const handleSubmit = (e) => __async(undefined, null, function* () {
    e.preventDefault();
