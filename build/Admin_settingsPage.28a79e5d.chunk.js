...
var customRoutes=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(49475)/* ["default"] */ .Z);}return (__webpack_require__(73258)/* ["default"] */ .Z);}();/* harmony default export */ const routes = ([].concat((0,toConsumableArray/* default */.Z)(customRoutes),(0,toConsumableArray/* default */.Z)(utils_defaultRoutes)));
...
function SettingsPage() {
  ...
  const adminRoutes = (0,react.useMemo)(() => {
    return (0,utils/* makeUniqueRoutes */.WW)(routes.map(({ to, Component, exact }) => (0,utils/* createRoute */.ot)(Component, to, exact)));
  }, []);
...
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;})),keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{};i%2?ownKeys(Object(source),!0).forEach(function(key){(0,defineProperty/* default */.Z)(target,key,source[key]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}return target;}var IS_DISABLED=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(15272)/* ["default"] */ .Z);}return (__webpack_require__(14934)/* ["default"] */ .Z);}();var FlexWrapper=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Flex.Flex).withConfig({displayName:"ActionRow__FlexWrapper",componentId:"sc-1bqpgdl-0"})(["height:",";"],rowHeight);var ActionRow=function ActionRow(_ref){var arrayOfOptionsGroupedByCategory=_ref.arrayOfOptionsGroupedByCategory,isFormDisabled=_ref.isFormDisabled,isGrey=_ref.isGrey,label=_ref.label,name=_ref.name,onChange=_ref.onChange,value=_ref.value;var _useIntl=(0,react_intl.useIntl)(),formatMessage=_useIntl.formatMessage;var options=arrayOfOptionsGroupedByCategory.reduce(function(arr,curr){var _curr=(0,slicedToArray/* default */.Z)(curr,2),label=_curr[0],children=_curr[1];var obj={label:upperFirst_default()(label),children:children.map(function(child){return{label:child.displayName,value:child.id};})};return[].concat((0,toConsumableArray/* default */.Z)(arr),[obj]);},[]);// Output: ['value1', 'value2']
...
const createDefaultConditionsForm = (actionsToDisplay, modifiedData, arrayOfOptionsGroupedByCategory) => {
  return actionsToDisplay.reduce((acc, current) => {
    const valueFromModifiedData = (0,lodash.get)(modifiedData, [...current.pathToConditionsObject, "conditions"], {});
    const categoryDefaultForm = createCategoryForm(arrayOfOptionsGroupedByCategory, valueFromModifiedData);
...
const ConditionsModal = ({ actions, headerBreadCrumbs, isFormDisabled, onClosed, onToggle }) => {
  ...
  const actionsToDisplay = actions.filter(({ isDisplayed, hasSomeActionsSelected, hasAllActionsSelected }) => isDisplayed && (hasSomeActionsSelected || hasAllActionsSelected));
  const initState = (0,react.useMemo)(() => {
    return utils_createDefaultConditionsForm(actionsToDisplay, modifiedData, arrayOfOptionsGroupedByCategory);
  }, [actionsToDisplay, modifiedData, arrayOfOptionsGroupedByCategory]);
  const [state, setState] = (0,react.useState)(initState);
  const handleChange = (name, values) => {
    setState((0,immer_cjs_production_min["default"])((draft) => {
      if (!draft[name]) {
        draft[name] = {};
      }
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout.ModalLayout, {
    ...
    key: label
  }, upperFirst_default()(formatMessage({
    id: label,
...
const createArrayOfValues = (obj) => {
  ...
  return (0,lodash.flattenDeep)(Object.values(obj).map((value) => {
...
const CollapsePropertyMatrix = ({
  ...
  const propertyActions = (0,react.useMemo)(() => utils_generateHeadersFromActions(availableActions, propertyName), [availableActions, propertyName]);
...
ContentTypeCollapses.propTypes = {
  ...
  isFormDisabled: (prop_types_default()).bool.isRequired,
  pathToData: (prop_types_default()).string.isRequired,
  subjects: prop_types_default().arrayOf(prop_types_default().shape({
...
const PermissionRow = ({
  ...
  return /* @__PURE__ */ react.createElement(Accordion.Accordion, {
    ...
    description: `${formatMessage({ id: "Settings.permissions.category" }, { category: categoryName })} ${kind === "plugins" ? "plugin" : kind}`
...
PluginsAndSettingsPermissions.propTypes = {
  isFormDisabled: (prop_types_default()).bool.isRequired,
  kind: (prop_types_default()).string.isRequired,
  layout: prop_types_default().arrayOf(prop_types_default().shape({
    category: (prop_types_default()).string.isRequired,
    categoryId: (prop_types_default()).string.isRequired,
    childrenForm: prop_types_default().arrayOf(prop_types_default().shape({
      actions: (prop_types_default()).array.isRequired
    })).isRequired
  ...
  return children.reduce((acc, current) => {
    if (current.children) {
      return createDefaultCTFormFromLayout_spreadProps(createDefaultCTFormFromLayout_spreadValues({}, acc), {
        [current.value]: createDefaultPropertyForms(current, propertyValues, `${prefix}${current.value}.`)
      });
    }
...
const createDefaultPropertiesForm = (propertiesArray, ctLayout, matchingPermission) => {
  return propertiesArray.reduce((acc, currentPropertyName) => {
    ...
    if (foundProperty) {
      const matchingPermissionPropertyValues = (0,lodash.get)(matchingPermission, ["properties", foundProperty.value], []);
      const propertyForm = createDefaultPropertyForms(foundProperty, matchingPermissionPropertyValues);
...
const createDefaultCTFormFromLayout = ({ subjects }, actionArray, conditionArray, initialPermissions = []) => {
  return actionArray.reduce((defaultForm, current) => {
    ...
    const contentTypesActions = Object.keys(subjectLayouts).reduce((acc, currentCTUID) => {
      ...
      const conditionsForm = createDefaultCTFormFromLayout_createDefaultConditionsForm(conditionArray, (0,lodash.get)(matchingPermission, "conditions", []));
...
const createSubCategoryForm = (actions, conditions, permissions) => {
  return actions.reduce((acc, current) => {
    ...
    acc[current.action] = {
      ...
      conditions: createDefaultCTFormFromLayout_createDefaultConditionsForm(conditions, (0,lodash.get)(foundMatchingPermission, "conditions", []))
    };
    return acc;
  }, {});
};
...
const createDefaultPluginsFormFromLayout = (pluginsLayout, conditions, initialPermissions = []) => {
  return pluginsLayout.reduce((acc, { categoryId, childrenForm }) => {
    const childrenDefaultForm = createChildrenDefaultForm(childrenForm, conditions, initialPermissions);
...
const init = (layout, permissions) => {
  ...
  const defaultForm = {
    collectionTypes: utils_createDefaultCTFormFromLayout(collectionTypes, collectionTypes.actions || [], conditions, permissions),
    singleTypes: utils_createDefaultCTFormFromLayout(singleTypes, singleTypes.actions || [], conditions, permissions),
...
const updateConditionsToFalse = (obj) => {
  return Object.keys(obj).reduce((acc, current) => {
    ...
    if ((0,lodash.isObject)(currentValue) && (0,lodash.has)(currentValue, "conditions")) {
      const isActionEnabled = utils_createArrayOfValues((0,lodash.omit)(currentValue, "conditions")).some((val) => val);
      if (!isActionEnabled) {
  ...
  switch (action.type) {
    case "ON_CHANGE_COLLECTION_TYPE_GLOBAL_ACTION_CHECKBOX": {
      ...
      Object.keys((0,lodash.get)(state, pathToData)).forEach((collectionType) => {
        const collectionTypeActionData = (0,lodash.get)(state, [...pathToData, collectionType, actionId], void 0);
    ...
    case "ON_CHANGE_CONDITIONS": {
      Object.entries(action.conditions).forEach((array) => {
        ...
        (0,lodash.set)(draftState, ["modifiedData", ...stringPathToData.split(".."), "conditions"], conditionsToUpdate);
      });
      break;
    }
...
const createPermissionWithProperties = (action, subject, { conditions, properties }) => {
  return Object.entries(properties).reduce((acc, current) => {
...
const createSubjectPermissions = (subject, actions) => {
  const permissions = Object.entries(actions).reduce((acc, current) => {
    ...
    if (!(0,lodash.has)(permissions2, "properties.enabled")) {
      const createdPermissionsArray = createPermissionWithProperties(actionName, subject, permissions2);
...
const formatPermissionsToAPI = (modifiedData) => {
  ...
  const collectionTypesPermissions = utils_formatContentTypesPermissionToAPI(modifiedData.collectionTypes);
...
const Permissions = (0,react.forwardRef)(({ layout, isFormDisabled, permissions }, ref) => {
  const [{ initialData, layouts, modifiedData }, dispatch] = (0,react.useReducer)(Permissions_reducer, initialState, () => Permissions_init(layout, permissions));
  const { formatMessage } = (0,react_intl.useIntl)();
  (0,react.useImperativeHandle)(ref, () => {
    return {
      getPermissions: () => {
        const collectionTypesDiff = (0,build.difference)(initialData.collectionTypes, modifiedData.collectionTypes);
        ...
        if (isEmpty_default()(contentTypesDiff)) {
          ...
          didUpdateConditions = Object.values(contentTypesDiff).some((permission) => {
            return Object.values(permission).some((permissionValue) => has_default()(permissionValue, "conditions"));
          });
        }
...
const RoleRow = ({ id, name, description, usersCount, icons }) => {
  ...
  }, _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_6__.stopPropagation), icons.map((icon, i) => icon ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_1__.Box, {
    key: icon.label,
    paddingLeft: i === 0 ? 0 : 1
...
// EXTERNAL MODULE: ./.cache/admin/src/assets/images/hot-air-balloon.png
var hot_air_balloon = __webpack_require__(12285);
// EXTERNAL MODULE: ./.cache/admin/src/assets/images/upgrade-details.png
var upgrade_details = __webpack_require__(31652);
...
const useRoleActions = () => {
  ...
  const handleGoTo = (0,react.useCallback)((id) => {
  ...
  const getIcons = (0,react.useCallback)((role) => [
    {
...
var Permissions = __webpack_require__(79160);
// EXTERNAL MODULE: ./.cache/admin/src/hooks/index.js + 27 modules
var hooks = __webpack_require__(32104);
// EXTERNAL MODULE: ./.cache/admin/src/permissions/index.js + 1 modules
var permissions = __webpack_require__(92699);
...
const CreatePage = () => {
  ...
  const handleCreateRoleSubmit = (data) => {
    ...
    Promise.resolve((0,build.request)("/admin/roles", {
      method: "POST",
      body: data
    })).then((res) => __async(undefined, null, function* () {
  ...
  }, { number: 0 }))), /* @__PURE__ */ react.createElement(Grid.Grid, {
    gap: 4
  }, /* @__PURE__ */ react.createElement(Grid.GridItem, {
    col: 6
...
const useRoleActions = ({ getData, canCreate, canDelete, canUpdate }) => {
  ...
  const { push } = (0,react_router_dom_min.useHistory)();
  const [{ selectedRoles, showModalConfirmButtonLoading, roleToDelete }, dispatch] = (0,react.useReducer)(ListPage_reducer, initialState);
  const handleDeleteData = () => __async(undefined, null, function* () {
    try {
      dispatch({
  ...
  const onRoleDuplicate = (0,react.useCallback)((id) => {
  ...
  const handleClickDelete = (0,react.useCallback)((e, role) => {
    e.preventDefault();
    e.stopPropagation();
    if (role.usersCount) {
      toggleNotification({
  ...
  const handleClickDuplicate = (0,react.useCallback)((e, role) => {
    e.preventDefault();
    e.stopPropagation();
...
const RoleListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, {
    ...
    startActions: /* @__PURE__ */ react.createElement(build.SearchURLQuery, {
      label: formatMessage({ id: "app.component.search.label", defaultMessage: "Search for {target}" }, { target: title })
    })
...
const ssoRoutes = strapi.features.isEnabled(strapi.features.SSO) ? [
  {
    Component: () => __async(undefined, null, function* () {
      const component = yield __webpack_require__.e(/* import() | sso-settings-page */ 302).then(__webpack_require__.bind(__webpack_require__, 6688));
      return component;
    }),
...
module.exports = __webpack_require__.p + "c3de6118ef47086ad05c.png";
...
module.exports = __webpack_require__.p + "bd81ba6c07827282255d.png";
