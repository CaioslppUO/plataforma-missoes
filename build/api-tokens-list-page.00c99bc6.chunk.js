...
const LinkUpdate = (0,styled_components_browser_cjs["default"])(Link.Link)`
  svg {
    path {
...
const ApiTokenListView = () => {
  ...
  const { data: apiTokens, status, isFetching } = (0,lib.useQuery)(["api-tokens"], () => __async(undefined, null, function* () {
  ...
  const deleteMutation = (0,lib.useMutation)((id) => __async(undefined, null, function* () {
    yield utils/* axiosInstance.delete */.be["delete"](`/admin/api-tokens/${id}`);
  }), {
    onSuccess: () => __async(undefined, null, function* () {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, {
    ...
    primaryAction: canCreate ? /* @__PURE__ */ react.createElement(LinkButton.LinkButton, {
