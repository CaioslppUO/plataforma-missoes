...
const ApiTokenCreateView = () => {
  ...
  const { status, data } = (0,lib.useQuery)(["api-token", id], () => __async(undefined, null, function* () {
    const {
      data: { data: data2 }
  ...
  const handleSubmit = (body, actions) => __async(undefined, null, function* () {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, {
    ...
    return /* @__PURE__ */ react.createElement(build.Form, null, /* @__PURE__ */ react.createElement(Layout.HeaderLayout, {
      ...
      name: "name",
      error: errors.name ? formatMessage(((_a2 = errors.name) == null ? void 0 : _a2.id) ? errors.name : { id: errors.name, defaultMessage: errors.name }) : null,
      label: formatMessage({
      ...
      name: "description",
      error: errors.description ? formatMessage(((_b = errors.description) == null ? void 0 : _b.id) ? errors.description : {
      ...
      value: values.type,
      error: errors.type ? formatMessage(((_c = errors.type) == null ? void 0 : _c.id) ? errors.type : { id: errors.type, defaultMessage: errors.type }) : null,
      onChange: (value) => {
...
/* harmony import */ var _EditView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(61344);
