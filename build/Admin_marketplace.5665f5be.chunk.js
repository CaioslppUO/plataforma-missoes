...
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* binding */ hooks_useFetchInstalledPlugins)
});
...
;// CONCATENATED MODULE: ./.cache/admin/src/hooks/useFetchInstalledPlugins/utils/api.js
...
const fetchInstalledPlugins = () => __async(undefined, null, function* () {
  const { data } = yield utils/* axiosInstance.get */.be.get("/admin/plugins");
  return data;
});


;// CONCATENATED MODULE: ./.cache/admin/src/hooks/useFetchInstalledPlugins/index.js



const useFetchInstalledPlugins = (notifyLoad) => {
  const toggleNotification = (0,build.useNotification)();
  return (0,lib.useQuery)("list-installed-plugins", () => fetchInstalledPlugins(), {
    onSuccess: () => {
      if (notifyLoad) {
        notifyLoad();
      }
...
/* harmony default export */ const hooks_useFetchInstalledPlugins = (useFetchInstalledPlugins);
...
// EXTERNAL MODULE: ./.cache/admin/src/assets/images/icon_made-by-strapi.svg
var icon_made_by_strapi = __webpack_require__(22139);
...
;// CONCATENATED MODULE: ./.cache/admin/src/pages/MarketplacePage/components/PluginCard/InstallPluginButton.js
...
/* harmony default export */ const PluginCard_InstallPluginButton = (InstallPluginButton);

;// CONCATENATED MODULE: ./.cache/admin/src/pages/MarketplacePage/components/PluginCard/index.js
...
const PluginCard = ({ plugin, installedPluginNames, useYarn, isInDevelopmentMode }) => {
  ...
  })), /* @__PURE__ */ react.createElement(PluginCard_InstallPluginButton, {
    isInstalled,
    isInDevelopmentMode,
    commandToCopy
  })));
...
PluginCard.propTypes = {
  plugin: prop_types_default().shape({
    ...
    attributes: prop_types_default().shape({
      ...
      strapiCompatibility: prop_types_default().oneOf(["v3", "v4"]).isRequired
    }).isRequired
  }).isRequired,
  installedPluginNames: prop_types_default().arrayOf((prop_types_default()).string).isRequired,
  useYarn: (prop_types_default()).bool.isRequired,
  isInDevelopmentMode: (prop_types_default()).bool
};
/* harmony default export */ const components_PluginCard = (PluginCard);
...
;// CONCATENATED MODULE: ./.cache/admin/src/pages/MarketplacePage/components/EmptyPluginSearch/EmptyPluginGrid.js
...
;// CONCATENATED MODULE: ./.cache/admin/src/pages/MarketplacePage/components/EmptyPluginSearch/index.js
...
const EmptyPluginSearch = ({ content }) => {
  return /* @__PURE__ */ react.createElement(Box.Box, {
    position: "relative"
  }, /* @__PURE__ */ react.createElement(EmptyPluginGrid, null), /* @__PURE__ */ react.createElement(Box.Box, {
    position: "absolute",
    top: 11,
    width: "100%"
  }, /* @__PURE__ */ react.createElement(Flex.Flex, {
...
var Upload = __webpack_require__(24556);
...
// EXTERNAL MODULE: ./.cache/admin/src/core/utils/index.js + 2 modules
var utils = __webpack_require__(63955);
;// CONCATENATED MODULE: ./.cache/admin/src/pages/MarketplacePage/utils/api.js
var __async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
...
const fetchAppInformation = () => __async(undefined, null, function* () {
  const { data } = yield utils/* axiosInstance.get */.be.get("/admin/information");
  return data;
});


// EXTERNAL MODULE: ./.cache/admin/src/hooks/useFetchInstalledPlugins/index.js + 1 modules
var useFetchInstalledPlugins = __webpack_require__(35762);
...
const fetchMarketplacePlugins = () => api_async(undefined, null, function* () {
  const { data: response } = yield axios_default().get(`${MARKETPLACE_API_URL}/plugins`);
...
const useFetchMarketplacePlugins = (notifyLoad) => {
  const toggleNotification = (0,build.useNotification)();
  return (0,lib.useQuery)("list-marketplace-plugins", () => fetchMarketplacePlugins(), {
    onSuccess: () => {
      if (notifyLoad) {
        notifyLoad();
      }
...
// EXTERNAL MODULE: ./.cache/admin/src/assets/images/icon_offline-cloud.svg
var icon_offline_cloud = __webpack_require__(87438);
...
const matchSearch = (plugins, search) => {
  return (0,match_sorter_cjs/* default */.ZP)(plugins, search, {
    keys: [
      {
...
const MarketPlacePage = () => {
  ...
  const { autoReload: isInDevelopmentMode } = (0,build.useAppInfos)();
  ...
  } = (0,useFetchInstalledPlugins/* default */.Z)();
  const { data: appInfoResponse, status: appInfoStatus } = (0,lib.useQuery)("app-information", fetchAppInformation, {
    onError: () => {
      toggleNotification({
        type: "warning",
        message: { id: "notification.error", defaultMessage: "An error occured" }
  ...
  const isLoading = [marketplacePluginsStatus, installedPluginsStatus, appInfoStatus].includes("loading");
  const hasFailed = [marketplacePluginsStatus, installedPluginsStatus, appInfoStatus].includes("error");
  (0,react.useEffect)(() => {
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(Helmet.Helmet, {
    ...
    id: "admin.pages.MarketPlacePage.search.placeholder",
    defaultMessage: "Search for a plugin"
  }))), searchQuery.length > 0 && !searchResults.length ? /* @__PURE__ */ react.createElement(EmptyPluginSearch, {
    ...
    gap: 4
  }, searchResults.map((plugin) => /* @__PURE__ */ react.createElement(Grid.GridItem, {
    col: 4,
    s: 6,
    xs: 12,
    style: { height: "100%" },
    key: plugin.id
  }, /* @__PURE__ */ react.createElement(components_PluginCard, {
    plugin,
...
"use strict";
module.exports = __webpack_require__.p + "a6b842e0b6d2b61135d1.svg";
