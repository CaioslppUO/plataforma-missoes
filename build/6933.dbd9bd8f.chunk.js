(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[6933],{
...
var UnauthenticatedLayout = __webpack_require__(83137);
// EXTERNAL MODULE: ./.cache/admin/src/components/UnauthenticatedLogo/index.js
var UnauthenticatedLogo = __webpack_require__(87173);
...
var FieldActionWrapper = __webpack_require__(11145);
...
const Register = ({ authType, fieldsToDisable, noSignin, onSubmit, schema }) => {
  ...
  (0,react.useEffect)(() => {
    if (registrationToken) {
      const getData = () => __async(undefined, null, function* () {
        try {
          const {
            data: { data }
          } = yield axios_default().get(`${strapi.backendURL}/admin/registration-info?registrationToken=${registrationToken}`);
          if (data) {
            setUserInfo(data);
          }
        } catch (err) {
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(dist.Formik, {
    ...
    onSubmit: (data, formik) => __async(undefined, null, function* () {
      try {
        ...
        if (registrationToken) {
          onSubmit({ userInfo: omit_default()(data, ["registrationToken"]), registrationToken }, formik);
        } else {
...
var customPermissions=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(601)/* ["default"] */ .Z);}return (__webpack_require__(57050)/* ["default"] */ .Z);}();var permissions_permissions=(0,lodash.merge)(defaultPermissions,customPermissions);/* harmony default export */ const src_permissions = (permissions_permissions);
...
var invariant = __webpack_require__(46128);
...
var apis = __webpack_require__(72256);
// EXTERNAL MODULE: ./node_modules/@strapi/helper-plugin/build/index.js
var build = __webpack_require__(68547);
// EXTERNAL MODULE: ./node_modules/@strapi/admin/node_modules/@strapi/design-system/Main.js
var Main = __webpack_require__(80117);
...
var useLocalesProvider = __webpack_require__(20088);
// EXTERNAL MODULE: ./.cache/admin/src/utils/formatAPIErrors.js
var formatAPIErrors = __webpack_require__(7043);
...
var NotFoundPage = __webpack_require__(92776);
// EXTERNAL MODULE: ./node_modules/styled-components/dist/styled-components.browser.cjs.js
var styled_components_browser_cjs = __webpack_require__(78384);
...
const getUniqueIdentifier = () => __async(undefined, null, function* () {
...
var customRoutes=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(33948)/* ["default"] */ .Z);}return (__webpack_require__(36248)/* ["default"] */ .Z);}();/* harmony default export */ const routes = ([].concat((0,toConsumableArray/* default */.Z)(customRoutes),(0,toConsumableArray/* default */.Z)(utils_defaultRoutes)));
...
const AuthenticatedApp = (0,react.lazy)(() => Promise.all(/* import() | Admin-authenticatedApp */[__webpack_require__.e(7814), __webpack_require__.e(5775), __webpack_require__.e(801)]).then(__webpack_require__.bind(__webpack_require__, 63339)));
function App() {
  const toggleNotification = (0,build.useNotification)();
  const { formatMessage } = (0,react_intl.useIntl)();
  const [{ isLoading, hasAdmin, uuid }, setState] = (0,react.useState)({ isLoading: true, hasAdmin: false });
  const authRoutes = (0,react.useMemo)(() => {
    return (0,src_utils/* makeUniqueRoutes */.WW)(routes.map(({ to, Component, exact }) => (0,src_utils/* createRoute */.ot)(Component, to, exact)));
  }, []);
  (0,react.useEffect)(() => {
  ...
  (0,react.useEffect)(() => {
    const getData = () => App_async(this, null, function* () {
      try {
        const {
          data: { hasAdmin: hasAdmin2, uuid: uuid2 }
        } = yield (0,build.request)("/admin/init", { method: "GET" });
        if (uuid2) {
          try {
...
// EXTERNAL MODULE: ./.cache/admin/src/assets/images/logo_strapi_auth_v4.png
var logo_strapi_auth_v4 = __webpack_require__(83522);
// EXTERNAL MODULE: ./.cache/admin/src/assets/images/logo_strapi_menu.png
var logo_strapi_menu = __webpack_require__(42201);
...
var context = __webpack_require__(78033);
...
const languageProviderReducer = (state = reducer_initialState, action) => {
  switch (action.type) {
    case "CHANGE_LOCALE": {
      const { locale } = action;
...
const LanguageProvider = ({ children, localeNames, messages }) => {
  const [{ locale }, dispatch] = (0,react.useReducer)(LanguageProvider_reducer, reducer_initialState, () => LanguageProvider_init(localeNames));
  (0,react.useEffect)(() => {
...
const reducer_reducer = (state = GuidedTour_reducer_initialState, action) => (0,immer_cjs_production_min["default"])(state, (draftState) => {
  switch (action.type) {
...
const GuidedTour = ({ children }) => {
  const [{ currentStep, guidedTourState, isGuidedTourVisible, isSkipped }, dispatch] = (0,react.useReducer)(GuidedTour_reducer, GuidedTour_reducer_initialState, GuidedTour_init);
...
const Blocker = ({ displayedIcon, description, title, isOpen }) => {
  ...
  if (isOpen) {
    return react_dom.createPortal(/* @__PURE__ */ react.createElement(Overlay, null, /* @__PURE__ */ react.createElement(Content, {
      spacing: 6
    }, /* @__PURE__ */ react.createElement(Stack.Stack, {
      spacing: 2
    }, /* @__PURE__ */ react.createElement(Flex.Flex, {
...
var hooks = __webpack_require__(32104);
...
const loadCss = () => GlobalStyle_async(undefined, null, function* () {
...
const Providers = ({
  ...
  return /* @__PURE__ */ react.createElement(components_ThemeToggleProvider, {
    ...
    client: queryClient
  }, /* @__PURE__ */ react.createElement(react_redux_lib/* Provider */.zt, {
    store
  }, /* @__PURE__ */ react.createElement(contexts/* AdminContext.Provider */.ux.Provider, {
    value: { getAdminInjectedComponents }
  }, /* @__PURE__ */ react.createElement(contexts/* ConfigurationsContext.Provider */._5.Provider, {
...
Providers.propTypes = {
  ...
  localeNames: prop_types_default().objectOf((prop_types_default()).string).isRequired,
  menu: prop_types_default().arrayOf(prop_types_default().shape({
...
// EXTERNAL MODULE: ./.cache/admin/src/favicon.ico
var favicon = __webpack_require__(85764);
...
class StrapiApp {
  constructor({ adminConfig, appPlugins, library, middlewares, reducers }) {
    ...
    __publicField(this, "addCorePluginMenuLink", (link) => {
      ...
      invariant_default()(link.to, `link.to should be defined for ${stringifiedLink}`);
      invariant_default()(typeof link.to === "string", `Expected link.to to be a string instead received ${typeof link.to}`);
      invariant_default()(["/plugins/content-type-builder", "/plugins/upload"].includes(link.to), "This method is not available for your plugin");
      invariant_default()(((_a = link.intlLabel) == null ? void 0 : _a.id) && ((_b = link.intlLabel) == null ? void 0 : _b.defaultMessage), `link.intlLabel.id & link.intlLabel.defaultMessage for ${stringifiedLink}`);
      this.menu.push(link);
    });
    ...
    __publicField(this, "addMenuLink", (link) => {
      ...
      invariant_default()(typeof link.to === "string", `Expected link.to to be a string instead received ${typeof link.to}`);
      invariant_default()(((_a = link.intlLabel) == null ? void 0 : _a.id) && ((_b = link.intlLabel) == null ? void 0 : _b.defaultMessage), `link.intlLabel.id & link.intlLabel.defaultMessage for ${stringifiedLink}`);
      invariant_default()(link.Component && typeof link.Component === "function", `link.Component should be a valid React Component`);
      invariant_default()(link.icon && typeof link.icon === "function", `link.Icon should be a valid React Component`);
      this.menu.push(link);
    });
    ...
    __publicField(this, "addSettingsLink", (sectionId, link) => {
      var _a, _b;
      invariant_default()(this.settings[sectionId], "The section does not exist");
      const stringifiedLink = JSON.stringify(link);
      invariant_default()(link.id, `link.id should be defined for ${stringifiedLink}`);
      invariant_default()(((_a = link.intlLabel) == null ? void 0 : _a.id) && ((_b = link.intlLabel) == null ? void 0 : _b.defaultMessage), `link.intlLabel.id & link.intlLabel.defaultMessage for ${stringifiedLink}`);
      invariant_default()(link.to, `link.to should be defined for ${stringifiedLink}`);
      invariant_default()(link.Component && typeof link.Component === "function", `link.Component should be a valid React Component`);
    ...
    __publicField(this, "addSettingsLinks", (sectionId, links) => {
      invariant_default()(this.settings[sectionId], "The section does not exist");
      invariant_default()(Array.isArray(links), "TypeError expected links to be an array");
      links.forEach((link) => {
    ...
    __publicField(this, "createSettingSection", (section, links) => {
      var _a, _b;
      invariant_default()(section.id, "section.id should be defined");
      invariant_default()(((_a = section.intlLabel) == null ? void 0 : _a.id) && ((_b = section.intlLabel) == null ? void 0 : _b.defaultMessage), "section.intlLabel should be defined");
      invariant_default()(Array.isArray(links), "TypeError expected links to be an array");
      invariant_default()(this.settings[section.id] === void 0, "A similar section already exists");
    ...
    __publicField(this, "injectContentManagerComponent", (containerName, blockName, component) => {
      var _a;
      invariant_default()((_a = this.admin.injectionZones.contentManager[containerName]) == null ? void 0 : _a[blockName], `The ${containerName} ${blockName} zone is not defined in the content manager`);
      invariant_default()(component, "A Component must be provided");
    ...
    __publicField(this, "injectAdminComponent", (containerName, blockName, component) => {
      var _a;
      invariant_default()((_a = this.admin.injectionZones.admin[containerName]) == null ? void 0 : _a[blockName], `The ${containerName} ${blockName} zone is not defined in the admin`);
      invariant_default()(component, "A Component must be provided");
      this.admin.injectionZones.admin[containerName][blockName].push(component);
    });
    __publicField(this, "registerHook", (name, fn) => {
      invariant_default()(this.hooksDict[name], `The hook ${name} is not defined. You are trying to register a hook that does not exist in the application.`);
    ...
    this.configurations = {
      authLogo: logo_strapi_auth_v4,
      head: { favicon: favicon },
      locales: ["en"],
      menuLogo: logo_strapi_menu,
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(53547);
/* harmony import */ var _context__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(78033);
...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(32104);
...
`;
const Logo = () => {
  const { authLogo } = (0,_hooks__WEBPACK_IMPORTED_MODULE_1__/* .useConfigurations */ .um)();
...
var useConfigurations = __webpack_require__(80380);
// EXTERNAL MODULE: ./node_modules/@strapi/admin/node_modules/react/index.js
var react = __webpack_require__(53547);
// EXTERNAL MODULE: ./node_modules/@strapi/helper-plugin/build/index.js
var build = __webpack_require__(68547);
...
const reducer = (state, action) => (0,immer_cjs_production_min["default"])(state, (draftState) => {
  switch (action.type) {
    ...
    case "GET_MODELS_SUCCEDED": {
      const getContentTypeByKind = (kind) => action.contentTypes.filter((contentType) => contentType.isDisplayed && contentType.kind === kind);
      draftState.isLoading = false;
...
const useModels = () => {
  ...
  const fetchModels = () => __async(undefined, null, function* () {
    dispatch({
      type: "GET_MODELS"
    });
    try {
      const [{ data: components }, { data: contentTypes }] = yield Promise.all(["components", "content-types"].map((endPoint) => (0,build.request)(`/content-manager/${endPoint}`, { method: "GET" })));
      dispatch({
...
const useFetchPermissionsLayout = (id) => {
  ...
  (0,react.useEffect)(() => {
    const getData = () => useFetchPermissionsLayout_async(undefined, null, function* () {
      dispatch({
        type: "GET_DATA"
      });
...
const useFetchRole = (id) => {
  ...
  const fetchRole = (roleId) => useFetchRole_async(undefined, null, function* () {
    try {
      const [{ data: role }, { data: permissions }] = yield Promise.all([`roles/${roleId}`, `roles/${roleId}/permissions`].map((endPoint) => (0,build.request)(`/admin/${endPoint}`, { method: "GET" })));
      dispatch({
        type: "GET_DATA_SUCCEEDED",
        role,
        permissions
...
const getPluginSectionLinks = (userPermissions, pluginsSectionRawLinks) => getPluginSectionLinks_async(undefined, null, function* () {
  const pluginSectionPermissionsPromises = utils_checkPermissions(userPermissions, pluginsSectionRawLinks);
  const pluginSectionLinksPermissions = yield Promise.all(pluginSectionPermissionsPromises);
  const authorizedPluginSectionLinks = pluginsSectionRawLinks.filter((_, index) => pluginSectionLinksPermissions[index]);
...
const getGeneralLinks = (permissions, generalSectionRawLinks, shouldUpdateStrapi) => getGeneralLinks_async(undefined, null, function* () {
  ...
  const authorizedGeneralSectionLinks = generalSectionRawLinks.filter((_, index) => generalSectionLinksPermissions[index]);
...
const useMenu = () => {
  ...
  const resolvePermissions = (..._0) => useMenu_async(undefined, [..._0], function* (permissions = allPermissions) {
    const pluginsSectionLinks = menu;
    const authorizedPluginSectionLinks = yield utils_getPluginSectionLinks(permissions, pluginsSectionLinks);
    const authorizedGeneralSectionLinks = yield utils_getGeneralLinks(permissions, generalSectionLinksRef.current, shouldUpdateStrapiRef.current);
    dispatch({
...
const useRolesList = (shouldFetchData = true) => {
  const toggleNotification = (0,build.useNotification)();
  const [{ roles, isLoading }, dispatch] = (0,react.useReducer)(useRolesList_reducer, useRolesList_reducer_initialState, () => useRolesList_init(useRolesList_reducer_initialState, shouldFetchData));
  (0,react.useEffect)(() => {
    if (shouldFetchData) {
      fetchRolesList();
    }
  }, [shouldFetchData]);
  const fetchRolesList = (0,react.useCallback)(() => useRolesList_async(undefined, null, function* () {
    try {
      dispatch({
        type: "GET_DATA"
      });
    ...
    case "CHECK_PERMISSIONS_SUCCEEDED": {
      action.data.forEach((checkedPermissions) => {
        if (checkedPermissions.hasPermission) {
          (0,lodash.set)(draftState, ["menu", ...checkedPermissions.path.split("."), "isDisplayed"], checkedPermissions.hasPermission);
        }
      });
      draftState.menu.forEach((section, sectionIndex) => {
        draftState.menu[sectionIndex].links = section.links.filter((link) => link.isDisplayed === true);
      });
      draftState.isLoading = false;
      break;
    }
...
var customGlobalLinks=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(43202)/* ["default"] */ .Z);}return (__webpack_require__(41729)/* ["default"] */ .Z);}();/* harmony default export */ const globalLinks = ([].concat((0,toConsumableArray/* default */.Z)(utils_defaultGlobalLinks),(0,toConsumableArray/* default */.Z)(customGlobalLinks)));
...
const useSettingsMenu = (noCheck = false) => {
  ...
  const [{ isLoading, menu }, dispatch] = (0,react.useReducer)(useSettingsMenu_reducer, useSettingsMenu_reducer_initialState, () => useSettingsMenu_init(useSettingsMenu_reducer_initialState, { settings, shouldUpdateStrapi }));
  (0,react.useEffect)(() => {
    const getData = () => useSettingsMenu_async(undefined, null, function* () {
      const checkPermissions = (permissionsToCheck, path) => useSettingsMenu_async(this, null, function* () {
      ...
      const generateArrayOfPromises = (array) => {
        return array.reduce((acc, current, sectionIndex) => {
          const generateArrayOfPromises2 = (array2) => array2.map((link, index) => checkPermissions(array2[index].permissions, `${sectionIndex}.links.${index}`));
...
const useSettingsForm = (endPoint, schema, cbSuccess, fieldsToPick) => {
  ...
  (0,react.useEffect)(() => {
    const getData = () => useSettingsForm_async(undefined, null, function* () {
      try {
  ...
  const handleSubmit = (e) => useSettingsForm_async(undefined, null, function* () {
    e.preventDefault();
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(53547);
/* harmony import */ var _contexts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(40448);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(53547);
/* harmony import */ var _strapi_icons_EyeStriked__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(52973);
/* harmony import */ var _strapi_icons_EyeStriked__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_strapi_icons_EyeStriked__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _strapi_icons_Eye__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(31023);
/* harmony import */ var _strapi_icons_Eye__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_strapi_icons_Eye__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(94117);
/* harmony import */ var _strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _strapi_design_system_Main__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(80117);
/* harmony import */ var _strapi_design_system_Main__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_strapi_design_system_Main__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(40264);
/* harmony import */ var _strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _strapi_design_system_Link__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(56156);
/* harmony import */ var _strapi_design_system_Link__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_strapi_design_system_Link__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(68547);
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(45697);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_19__);
/* harmony import */ var react_intl__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(97132);
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(78384);
/* harmony import */ var formik__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(80831);
/* harmony import */ var _layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(83137);
/* harmony import */ var _components_UnauthenticatedLogo__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(87173);
/* harmony import */ var _FieldActionWrapper__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(11145);
...
const PasswordInput = (0,styled_components__WEBPACK_IMPORTED_MODULE_17__["default"])(_strapi_design_system_TextInput__WEBPACK_IMPORTED_MODULE_9__.TextInput)`
  ::-ms-reveal {
    display: none;
  }
`;
const Login = ({ onSubmit, schema, children }) => {
  ...
  const { formatMessage } = (0,react_intl__WEBPACK_IMPORTED_MODULE_18__.useIntl)();
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Main__WEBPACK_IMPORTED_MODULE_5__.Main, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_14__/* .LayoutContent */ .bU, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(formik__WEBPACK_IMPORTED_MODULE_13__.Formik, {
    enableReinitialize: true,
    initialValues: {
      email: "",
      password: "",
    ...
    validationSchema: schema,
    validateOnChange: false
  }, ({ values, errors, handleChange }) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_12__.Form, {
    noValidate: true
  }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_14__/* .Column */ .sg, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_UnauthenticatedLogo__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z, null), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_3__.Box, {
    paddingTop: 6,
    paddingBottom: 1
  ...
  }))), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_3__.Box, {
    paddingBottom: 7
  }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_11__.Typography, {
    variant: "epsilon",
    textColor: "neutral600"
    ...
    tabIndex: -1,
    textColor: "danger600"
  }, errors.errorMessage)), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Stack__WEBPACK_IMPORTED_MODULE_4__.Stack, {
    spacing: 6
    ...
    name: "password",
    type: passwordShown ? "text" : "password",
    endAction: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_FieldActionWrapper__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .Z, {
      onClick: (e) => {
        e.stopPropagation();
        setPasswordShown((prev) => !prev);
      },
    ...
    }, passwordShown ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement((_strapi_icons_Eye__WEBPACK_IMPORTED_MODULE_2___default()), null) : /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement((_strapi_icons_EyeStriked__WEBPACK_IMPORTED_MODULE_1___default()), null)),
    required: true
    ...
    fullWidth: true,
    type: "submit"
  }, formatMessage({ id: "Auth.form.button.login", defaultMessage: "Login" }))))), children), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_6__.Flex, {
    justifyContent: "center"
  }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_3__.Box, {
    paddingTop: 4
  }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Link__WEBPACK_IMPORTED_MODULE_7__.Link, {
...
Login.propTypes = {
  ...
  onSubmit: (prop_types__WEBPACK_IMPORTED_MODULE_19___default().func),
  schema: prop_types__WEBPACK_IMPORTED_MODULE_19___default().shape({
    type: (prop_types__WEBPACK_IMPORTED_MODULE_19___default().string.isRequired)
  }).isRequired
};
...
/* harmony import */ var _BaseLogin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13873);
/* harmony import */ var _layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(83137);
var __defProp = Object.defineProperty;
var __getOwnPropSymbols = Object.getOwnPropertySymbols;
var __hasOwnProp = Object.prototype.hasOwnProperty;
var __propIsEnum = Object.prototype.propertyIsEnumerable;
...
/* harmony import */ var _strapi_design_system_LinkButton__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(31512);
/* harmony import */ var _strapi_design_system_LinkButton__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_strapi_design_system_LinkButton__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _strapi_design_system_Layout__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(35395);
/* harmony import */ var _strapi_design_system_Layout__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_strapi_design_system_Layout__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _strapi_design_system_EmptyStateLayout__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(92543);
/* harmony import */ var _strapi_design_system_EmptyStateLayout__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_strapi_design_system_EmptyStateLayout__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _strapi_icons_EmptyPictures__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(40074);
/* harmony import */ var _strapi_icons_EmptyPictures__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_strapi_icons_EmptyPictures__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _strapi_icons_ArrowRight__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(64290);
...
const NoContentType = () => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Main__WEBPACK_IMPORTED_MODULE_2__.Main, {
    labelledBy: "title"
  }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Layout__WEBPACK_IMPORTED_MODULE_4__.HeaderLayout, {
    id: "title",
    title: formatMessage({
      id: "content-manager.pageNotFound",
      defaultMessage: "Page not found"
    })
  }), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Layout__WEBPACK_IMPORTED_MODULE_4__.ContentLayout, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_EmptyStateLayout__WEBPACK_IMPORTED_MODULE_5__.EmptyStateLayout, {
    action: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_LinkButton__WEBPACK_IMPORTED_MODULE_3__.LinkButton, {
      variant: "secondary",
      endIcon: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement((_strapi_icons_ArrowRight__WEBPACK_IMPORTED_MODULE_7___default()), null),
      to: "/"
    }, formatMessage({
    ...
    hasRadius: true,
    icon: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement((_strapi_icons_EmptyPictures__WEBPACK_IMPORTED_MODULE_6___default()), {
      width: "10rem"
    }),
    shadow: "tableShadow"
  })));
...
const checkFormValidity = (data, schema) => __async(undefined, null, function* () {
  let errors = null;
  try {
    yield schema.validate(data, { abortEarly: false });
  } catch (err) {
...
const LazyCompo = ({ loadComponent }) => {
  ...
  (0,react.useEffect)(() => {
    const loadCompo = () => createRoute_async(undefined, null, function* () {
      try {
...
const getExistingActions = (permissions) => {
  return Array.from(new Set(Object.entries(permissions).reduce((acc, current) => {
...
const useAuthProviders = ({ ssoEnabled }) => {
  ...
  const fetchAuthProviders = () => __async(undefined, null, function* () {
    try {
      if (!ssoEnabled) {
        dispatch({
          type: "GET_DATA_SUCCEEDED",
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _admin_src_permissions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(92699);
...
const AuthResponse = () => {
  ...
  let redirectToOops = (0,react.useCallback)(() => {
    push(`/auth/oops?info=${encodeURIComponent(formatMessageRef.current({
      id: "Auth.form.button.login.providers.error",
      defaultMessage: "We cannot connect you through the selected provider."
    }))}`);
  }, [push]);
  const fetchUserInfo = (0,react.useCallback)(() => __async(undefined, null, function* () {
    try {
...
/* harmony import */ var _admin_src_pages_AuthPage_components_Login_BaseLogin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13873);
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(81595);
/* harmony import */ var _admin_src_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(83137);
/* harmony import */ var _Providers_SSOProviders__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(84889);
var __defProp = Object.defineProperty;
var __getOwnPropSymbols = Object.getOwnPropertySymbols;
var __hasOwnProp = Object.prototype.hasOwnProperty;
var __propIsEnum = Object.prototype.propertyIsEnumerable;
...
var utils_forms = __webpack_require__(48858);
