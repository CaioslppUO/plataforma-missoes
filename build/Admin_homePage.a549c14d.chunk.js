...
// EXTERNAL MODULE: ./.cache/admin/src/assets/images/homepage-logo.png
var homepage_logo = __webpack_require__(42462);
...
const isGuidedTourCompleted = (guidedTourState) => Object.entries(guidedTourState).every(([, section]) => Object.entries(section).every(([, step]) => step));
...
StepperHomepage.propTypes = {
  sections: prop_types_default().arrayOf(prop_types_default().shape({
...
const GuidedTourHomepage = () => {
  ...
  const sections = Object.entries(layout/* default */.Z).map(([key, val]) => ({
    ...
    content: /* @__PURE__ */ react.createElement(LinkButton.LinkButton, {
