...
const Plugins = () => {
  ...
  const { status, data } = (0,useFetchInstalledPlugins/* default */.Z)(notifyPluginPageLoad);
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(Layout.HeaderLayout, {
    ...
    return /* @__PURE__ */ react.createElement(Table.Tr, {
      ...
      variant: "omega",
      fontWeight: "bold"
    }, displayName)), /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Typography.Typography, {
      textColor: "neutral800"
    }, description)));
  }))))));
};
